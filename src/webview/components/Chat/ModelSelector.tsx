...
import { MODEL_CATALOG } from '../../../utils/modelCapabilities';
import { getModelImageSupport } from '../../../utils/modelCapabilities';
                        ...
                        >
                            ...
                            <div className="model-selector-list">
                                {filteredModels.map((model) => {
                                    const imageSupport = getModelImageSupport(model.id);
                                    const capabilityLabel = imageSupport === 'supported'
                                        ? 'image'
                                        ...
                                        >
                                            ...
                                            <div className="model-info">
                                                <div className="model-name">
                                                    {model.name}
                                                    {capabilityLabel && (
                                                        <span className={`model-capability model-capability--${imageSupport}`}>
                                                            {capabilityLabel}
                                                        </span>
                                                    )}
                                                </div>
